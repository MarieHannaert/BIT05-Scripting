...
eclient = Client(api_key="12eda5a0a0426686d7b34a5c5ca47eeb0409")
...
################################################################################
gene_efetch = eclient.efetch(db='gene', id=7157) #you get an object, you don't know this object 
print("\n\nResults of gene efetch:\n{}".format(gene_efetch))

#explore efetch object 
obj_gene_efetch = dir(gene_efetch)
print(obj_gene_efetch)
