...
location ="/media/sf_SF/BIT05-scripting/5. filesystems, writing and reading/"
os.chdir(location)
print("\nCurrent working directory: ", os.getcwd())
################################################################################
# Create a new folder
...
newdir ="/media/sf_SF/BIT09-HTA/newdir/"
os.mkdir(newdir)
...
location = "/media/sf_SF/BIT05-scripting/5. filesystems, writing and reading/fastqc/"
os.chdir(location)
...
iternames = glob.iglob("/media/sf_SF/BIT05-scripting/**/*.py",recursive=True)
